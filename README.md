...
2022-11-27 今晚翻出了这个几年前的项目，看了 README 后感叹，那是刚开始学习 js 时写的，那时的我会在 for loop 中写 `if(x=0) { }` 把风扇转得跟发动机一样而半天查不出错误，最后这个项目也能跑，还记录了犯下的错误。今晚把它做了基于 ES6 class 的重构，增加了一点小功能。现在它高低能跑，但操作dom的方式实现动画的方式真的很消耗性能。
